...
#define GPIO_SIZE_SIZE 4096UL

/* The list of GPIO registers and their offset from the GPIO base address: See TRM*/
#define GPIO_REVISION_OFFSET 0h
#define GPIO_SYSCONFIG_OFFSET 10h
#define GPIO_EOI_OFFSET 20h
#define GPIO_IRQSTATUS_RAW_0_OFFSET 24h
#define GPIO_IRQSTATUS_RAW_1_OFFSET 28h
#define GPIO_IRQSTATUS_0_OFFSET 2Ch
#define GPIO_IRQSTATUS_1_OFFSET 30h
#define GPIO_IRQSTATUS_SET_0_OFFSET 34h
#define GPIO_IRQSTATUS_SET_1_OFFSET 38h
#define GPIO_IRQSTATUS_CLR_0_OFFSET 3Ch
#define GPIO_IRQSTATUS_CLR_1_OFFSET 40h
#define GPIO_IRQWAKEN_0_OFFSET 44h
#define GPIO_IRQWAKEN_1_OFFSET 48h
#define GPIO_SYSSTATUS_OFFSET 114h
#define GPIO_CTRL_OFFSET 130h
#define GPIO_OE_OFFSET 134h
#define GPIO_DATAIN_OFFSET 138h
#define GPIO_DATAOUT_OFFSET 13Ch
#define GPIO_LEVELDETECT0_OFFSET 140h
#define GPIO_LEVELDETECT1_OFFSET 144h
#define GPIO_RISINGDETECT_OFFSET 148h
#define GPIO_FALLINGDETECT_OFFSET 14Ch
#define GPIO_DEBOUNCENABLE_OFFSET 150h
#define GPIO_DEBOUNCINGTIME_OFFSET 154h
#define GPIO_CLEARDATAOUT_OFFSET 190h
#define GPIO_SETDATAOUT_OFFSET 194h

const string GPIO::GPIO_PATH = "/sys/class/gpio/";

/* This array is organized in the following format:
   Column 1: GPIO_#
   Column 2: Physical header pin numbe
 */
